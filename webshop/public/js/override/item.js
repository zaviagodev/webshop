...
frappe.ui.form.on("Item", {
	...
	onload: function (frm) {
		frm.is_marketplace_integrated = false;
		frappe.call({
			method: "webshop.webshop.api.is_marketplace_integrated",
			callback: function (response) {
				frm.is_marketplace_integrated = response.message;
			}
		})
	},
	refresh: function (frm) {
		if(frm.is_marketplace_integrated) {
